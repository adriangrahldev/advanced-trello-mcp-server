...
server.tool('create-list', {
    ...
    try {
        ...
        const response = await fetch(`https://api.trello.com/1/lists?key=${trelloApiKey}&token=${trelloApiToken}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
server.tool('update-list', {
    ...
    try {
        ...
        const response = await fetch(`https://api.trello.com/1/lists/${listId}?key=${trelloApiKey}&token=${trelloApiToken}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
...
server.tool('archive-list', {
    ...
    try {
        ...
        const response = await fetch(`https://api.trello.com/1/lists/${listId}/closed?key=${trelloApiKey}&token=${trelloApiToken}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
...
server.tool('move-list-to-board', {
    ...
    try {
        ...
        const response = await fetch(`https://api.trello.com/1/lists/${listId}/idBoard?key=${trelloApiKey}&token=${trelloApiToken}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
...
server.tool('archive-all-cards-in-list', {
    ...
    try {
        ...
        const response = await fetch(`https://api.trello.com/1/lists/${listId}/archiveAllCards?key=${trelloApiKey}&token=${trelloApiToken}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
server.tool('update-label', {
    ...
    try {
        ...
        const response = await fetch(`https://api.trello.com/1/labels/${labelId}?key=${trelloApiKey}&token=${trelloApiToken}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
...
server.tool('update-action', {
    ...
    try {
        ...
        const response = await fetch(`https://api.trello.com/1/actions/${actionId}?key=${trelloApiKey}&token=${trelloApiToken}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
...
server.tool('get-action-field', {
    actionId: zod_1.z.string().describe('ID of the action'),
    field: zod_1.z.enum(['id', 'idMemberCreator', 'data', 'type', 'date', 'limits', 'display', 'memberCreator'])
    ...
    try {
        ...
        const response = await fetch(`https://api.trello.com/1/actions/${actionId}/${field}?key=${trelloApiKey}&token=${trelloApiToken}`);
        const data = await response.json();
        return {
            content: [
                {
...
server.tool('get-action-list', {
    actionId: zod_1.z.string().describe('ID of the action'),
    fields: zod_1.z.string().optional().describe('Comma-separated list of list fields to include')
}, async ({ actionId, fields }) => {
    try {
        if (!trelloApiKey || !trelloApiToken) {
            return {
...
server.tool('get-action-member', {
    actionId: zod_1.z.string().describe('ID of the action'),
    fields: zod_1.z.string().optional().describe('Comma-separated list of member fields to include')
}, async ({ actionId, fields }) => {
    try {
        if (!trelloApiKey || !trelloApiToken) {
            return {
...
server.tool('get-action-member-creator', {
    actionId: zod_1.z.string().describe('ID of the action'),
    fields: zod_1.z.string().optional().describe('Comma-separated list of member fields to include')
}, async ({ actionId, fields }) => {
    try {
...
server.tool('get-action-organization', {
    actionId: zod_1.z.string().describe('ID of the action'),
    fields: zod_1.z.string().optional().describe('Comma-separated list of organization fields to include')
}, async ({ actionId, fields }) => {
    try {
        if (!trelloApiKey || !trelloApiToken) {
            return {
...
server.tool('update-comment-action', {
    actionId: zod_1.z.string().describe('ID of the comment action to update'),
    value: zod_1.z.string().describe('New text content for the comment')
    ...
    try {
        ...
        const response = await fetch(`https://api.trello.com/1/actions/${actionId}/text?key=${trelloApiKey}&token=${trelloApiToken}&value=${encodeURIComponent(value)}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
...
server.tool('create-action-reaction', {
    actionId: zod_1.z.string().describe('ID of the action to react to'),
    shortName: zod_1.z.string().optional().describe('Short name of the emoji (e.g., "thumbsup")'),
    skinVariation: zod_1.z.string().optional().describe('Skin tone variation of the emoji'),
    native: zod_1.z.string().optional().describe('Native emoji character'),
    unified: zod_1.z.string().optional().describe('Unified emoji code')
    ...
    try {
        ...
        const reactionData = {};
        if (shortName)
            reactionData.shortName = shortName;
        if (skinVariation)
            reactionData.skinVariation = skinVariation;
        if (native)
            reactionData.native = native;
        if (unified)
            reactionData.unified = unified;
        const response = await fetch(`https://api.trello.com/1/actions/${actionId}/reactions?key=${trelloApiKey}&token=${trelloApiToken}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
server.tool('get-action-reaction', {
    actionId: zod_1.z.string().describe('ID of the action'),
    reactionId: zod_1.z.string().describe('ID of the reaction'),
    member: zod_1.z.boolean().optional().describe('Include member information'),
    emoji: zod_1.z.boolean().optional().describe('Include emoji information')
...
server.tool('delete-action-reaction', {
    actionId: zod_1.z.string().describe('ID of the action'),
    reactionId: zod_1.z.string().describe('ID of the reaction to delete')
    ...
    try {
        ...
        const response = await fetch(`https://api.trello.com/1/actions/${actionId}/reactions/${reactionId}?key=${trelloApiKey}&token=${trelloApiToken}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
            },
...
server.tool('get-action-reactions-summary', {
    actionId: zod_1.z.string().describe('ID of the action')
}, async ({ actionId }) => {
    try {
        if (!trelloApiKey || !trelloApiToken) {
        ...
        const response = await fetch(`https://api.trello.com/1/actions/${actionId}/reactionsSummary?key=${trelloApiKey}&token=${trelloApiToken}`);
        const data = await response.json();
        return {
            content: [
                {
